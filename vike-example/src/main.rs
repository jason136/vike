...
use vike::{
    ...
    game_object::{EulerRot, GameObjectStore, Quat, Transform3D, Vec3},
    renderer::Renderer,
    run_headless,
};
use winit::{
    ...
    async fn setup(
        ...
        game_objects.new_array(
            ...
            Box::new(|i: u32| {
                ...
                Transform3D {
                    position,
                    rotation: rotation.to_euler(EulerRot::XYZ).into(),
                    ..Default::default()
                }
            }),
        );
...
fn main() {
    ...
    block_on(run_headless(800, 600, &mut vike));
}
